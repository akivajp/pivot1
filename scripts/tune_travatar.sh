...
show_exec $TRAVATAR/script/mert/mert-travatar.pl -travatar-config ${moses_ini} -nbest 100 -src ${src1} -ref ${src2} -travatar-dir ${TRAVATAR} --working-dir ${workdir} \> ${task}/tune.log
